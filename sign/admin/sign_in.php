...
<body>
  <div class="container">
    <div class="card p-2 mt-5">
      ...
      <h1 class="pt-5 text-center title">Sign In</h1>
      <hr>
      <form action="" method="post" class="row g-3 p-4 needs-validation" novalidate>
        ...
        <div class="col-12">
          <button class="btn btn-primary btn-lg mt-3" type="submit" name="signIn">Sign In</button>
          <a class="btn btn-success btn-lg mt-3" href="../link_login.html">Batal</a>
        </div>
      </form>
    </div>
    <?php if(isset($error)) : ?>
