...
<body>
  ...
  <div class="container mt-5 p-4">
    ...
    <div class="alert alert-success" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?> </span> di Dashboard </div>

    <div class="d-flex flex-wrap justify-content-center gap-3">
      <div class="card bg-transparent border-light" style="width: 18rem;">
        <div class="card-body text-light">
          <h5 class="card-title">Daftar Buku</h5>
          <p class="card-text">List data buku.</p>
      ...
      <div class="card bg-transparent border-light" style="width: 18rem;">
        <div class="card-body text-light">
          ...
          <p class="card-text">Halaman peminjaman buku perpustakaan.</p>
          <a href="formPeminjaman/TransaksiPeminjaman.php" class="btn btn-outline-light">Buka</a>
        </div>
      </div>
      <div class="card bg-transparent border-light" style="width: 18rem;">
        <div class="card-body text-light">
          <h5 class="card-title">Pengembalian</h5>
          <p class="card-text">Halaman list pengembalian buku.</p>
          <a href="formPeminjaman/TransaksiPengembalian.php" class="btn btn-outline-light">Buka</a>
        </div>
      </div>
      <div class="card bg-transparent border-light" style="width: 18rem;">
        <div class="card-body text-light">
          <h5 class="card-title">Denda</h5>
          <p class="card-text"> Halanan melihat dan mengelola denda yang diterapkan.</p>
          <a href="formPeminjaman/TransaksiDenda.php" class="btn btn-outline-light">Buka</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer class="footer shadow-lg p-3">
    <div class="container-fluid d-flex justify-content-between">
      <p class="mt-2">Karya <span class="text-primary">Kelompok 1</span>P5</p>
</div>
