...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .btn-tertiary, .btn-danger, .btn-success {
        background-color: #795548;
        border-color: #795548;
        color: #FFFFFF;
      }
      .btn-tertiary:hover, .btn-danger:hover, .btn-success:hover {
  ...
  <body>
    ...
    <footer class="shadow-lg bg-subtle p-3">
      <div class="container-fluid d-flex justify-content-between">
        <p class="mt-2">Karya <span class="text-primary">P5 Kelompok 1</span> © 2024</p>
